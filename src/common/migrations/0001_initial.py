# -*- coding: utf-8 -*-
# Generated by Django 1.9 on 2016-03-04 06:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_address', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='common.EmailAddress')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('area', models.CharField(choices=[('US', 'United States'), ('CN', 'China'), ('SG', 'Singapore'), ('JP', 'Japan'), ('OT', 'Other')], default='OT', max_length=2)),
                ('experience', models.CharField(choices=[('A', '1-5 years'), ('B', '5-10 years'), ('C', '10-15 years'), ('D', '>15 years')], default='A', max_length=1)),
                ('industries', common.multichoice.MultiSelectField(blank=True, choices=[('MC', 'Management Consulting'), ('EN', 'Energy'), ('HI', 'Health care and Life Sciences'), ('BI', 'BioPharma'), ('ED', 'Education'), ('SE', 'Semiconductor'), ('SW', 'Software'), ('MB', 'Mobile Internet and Computing'), ('DS', 'Data and Storage'), ('VR', 'VR/AI/Robotics'), ('IT', 'Internet of Things'), ('GB', 'Gaming and Media'), ('ET', 'Entertainment'), ('TL', 'Transport and Logistics'), ('AU', 'Automotive'), ('CG', 'Consumer Goods'), ('OT', 'Other')], max_length=250)),
                ('expertise', common.multichoice.MultiSelectField(blank=True, choices=[('ST', 'Strategy'), ('BD', 'Business Development and Sales'), ('SP', 'Strategic Partnership'), ('MK', 'Marketing'), ('MT', 'Market Research'), ('OS', 'Operations and Supply Chain'), ('MA', 'Merger and Acquisition'), ('DA', 'Data Analytics'), ('SE', 'Software Engineering'), ('PJ', 'Project Management'), ('PD', 'Product Design and Development'), ('PM', 'Product Management'), ('EN', 'Entrepreneurship'), ('CC', 'Cloud Computing'), ('AD', 'Advertisement'), ('CL', 'Corporate Law'), ('CF', 'Corporate Finance'), ('AT', 'Accounting and Taxation'), ('OT', 'Other')], max_length=250)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expert_pref_text', models.CharField(default='', max_length=1000)),
                ...
                ('assign_history', models.CharField(default='', max_length=200)),
                ('state', models.CharField(choices=[('PC', 'Project is created'), ('PS', 'Project is submitted'), ('EA', 'An expert is assigned'), ('ET', 'An expert took this project'), ('CA', 'The client accepted this expert'), ('IP', 'An expert is working on it'), ('PF', 'Project is finished'), ('CC', 'The client has confirmed the project finish'), ('AD', 'The client has appealed the dispute to the administrator'), ('PR', 'Payment is received and the project is closed')], default='PC', max_length=2)),
                ...
                ('industry', models.CharField(choices=[('MC', 'Management Consulting'), ('EN', 'Energy'), ('HI', 'Health care and Life Sciences'), ('BI', 'BioPharma'), ('ED', 'Education'), ('SE', 'Semiconductor'), ('SW', 'Software'), ('MB', 'Mobile Internet and Computing'), ('DS', 'Data and Storage'), ('VR', 'VR/AI/Robotics'), ('IT', 'Internet of Things'), ('GB', 'Gaming and Media'), ('ET', 'Entertainment'), ('TL', 'Transport and Logistics'), ('AU', 'Automotive'), ('CG', 'Consumer Goods'), ('OT', 'Others')], default='OT', max_length=2)),
                ('expertise', models.CharField(choices=[('ST', 'Strategy'), ('BD', 'Business Development and Sales'), ('SP', 'Strategic Partnership'), ('MK', 'Marketing'), ('MT', 'Market Research'), ('OS', 'Operations and Supply Chain'), ('MA', 'Merger and Acquisition'), ('DA', 'Data Analytics'), ('SE', 'Software Engineering'), ('PJ', 'Project Management'), ('PD', 'Product Design and Development'), ('PM', 'Product Management'), ('EN', 'Entrepreneurship'), ('CC', 'Cloud Computing'), ('AD', 'Advertisement'), ('CL', 'Corporate Law'), ('CF', 'Corporate Finance'), ('AT', 'Accounting and Taxation'), ('OT', 'Others')], default='OT', max_length=2)),
                ('rate_type', models.CharField(choices=[('F', 'Fixed amount'), ('H', 'Hourly rate')], default='F', max_length=1)),
                ('service_type', models.CharField(choices=[('D', 'Deep dive'), ('G', 'General advisory')], default='G', max_length=1)),
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='common.Client')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('signup_code', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='common.SignupCode')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.CharField(default='Summary default.', max_length=500, verbose_name='Summary')),
                ('user_type', models.CharField(choices=[('CLIENT', 'CLIENT'), ('EXPERT', 'EXPERT')], default='CLIENT', max_length=20)),
                ('work_phone_number', models.CharField(blank=True, max_length=15, validators=[django.core.validators.RegexValidator(message="Phone number must be entered in the format: '+999999999'. Up to 15 digits allowed.", regex='^\\+?1?\\d{9,15}$')])),
                ('cell_phone_number', models.CharField(blank=True, max_length=15, validators=[django.core.validators.RegexValidator(message="Phone number must be entered in the format: '+999999999'. Up to 15 digits allowed.", regex='^\\+?1?\\d{9,15}$')])),
